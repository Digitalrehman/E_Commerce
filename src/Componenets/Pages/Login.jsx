    ...
    <div className="container my-2">
      <div className="row justify-content-center">
       ...
       <div className='text-center py-3 '>
        <h1 className='fw-bold text-dark'>Registration</h1>
       </div>
     <form>
      ...
      <MDBInput wrapperClass='mb-4' id='form6Example7' placeholder='Tell me about your mind' rows={4} label='Additional information' />
